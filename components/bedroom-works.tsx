...
export default function BedroomWorks() {
  ...
  const handlePrev = () => {
    if (selectedImageIndex !== null) {
      setSelectedImageIndex((prevIndex) =>
        prevIndex !== null ? (prevIndex - 1 + bedroomWorks.length) % bedroomWorks.length : null
      )
    }
  }
        ...
        <div className="flex flex-col md:flex-row items-start gap-8 mb-12">
          <div className="w-full md:w-[320px] lg:w-[370px] shrink-0 flex flex-col justify-start">
            <h2 className="text-5xl font-bold mb-4 text-gray-900 dark:text-white leading-tight text-left">
              Мебель для спальни на<br />заказ в Твери
            </h2>
            <p className="text-xl text-gray-500 text-left">
              Уютные спальные гарнитуры: кровати, шкафы-купе, комоды, туалетные столики. Создаем комфортное пространство для отдыха. Рассрочка 0%.
            </p>
          </div>
